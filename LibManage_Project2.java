...
class LibManage_Project2 extends LibManage_Project3
{
    ...
    public static boolean signIn() { //returns true if there is a match, false otherwise
        ...
        String username[]={"Krish", "Tannay", "Liyana"};
        String password[]={"KK1", "TG2", "LM3"};
        ...
        for(i=0; i<username.length;i++) {
            ...
            {
                if(ps.equals(password[i])) //username and password match
                    return true;
                else
                    return false;
            }
            ...
            switch(sc.next().charAt(0)) {
                ...
                case 'e'://Book Issue
                    ...
                    if(Issued[j])
                        ...
                        Return_date[i] = return_date_finder(Issue_date[i]);
                        sopln("Return Date is " + Return_date[i]);
                ...
                case 'f': //Calculate Late Fine 
                    ...
                    if(Issued[i]) { //if the book is issued
                        System.out.println("Enter the date you have return the book on. Ex: 25/06/23");
                        String user_return_date = sc.next();
                        ...
                        String t21= Issue_date[j];
                        String t12= user_return_date;
                        int issue_date_number = date_number_finder(Issue_date[j]);
                        int return_date_number = date_number_finder(user_return_date);
                        ...
                        if (date_dif <= 7) //if on time
                            ...
                            fees = date_dif-7;
                            sopln("The book was returned in " + date_dif + " days."
